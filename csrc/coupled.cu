...
__global__ void coupled_kernel(
    ...
    float contact_warm_start_factor,
  ...
  if(runtime_friction!=nullptr)friction=runtime_friction[0];
  if(runtime_restitution!=nullptr)restitution=runtime_restitution[0];
